export class editLeadsPage {
  EditLeadDetails() {
    // cy.get('[data-testid="SidebarField-dealValue"]').trigger('mouseover')
    //cy.get('> [class="cui5-button cui5-button--variant-secondary cui5-button--size-s"]').invoke('show').click()

  // cy.get('[data-testid="SidebarField-dealValue"]').realHover();
  // cy.get('[class="ExpandableSection__Wrapper-sc-wphg4w-2 hHpPBU"]>>[class="SidebarFieldWrapperstyles__FieldWrapper-sc-1p59g5d-1 iNlPyC"]> :nth-child(2)  >[class="ff_v882__ComponentState__wrapperEdit__Vyl ff__edit"]>:nth-child(2)>  [class="cui5-button cui5-button--variant-secondary cui5-button--size-s"]').should('have.css','visibility', 'hidden').invoke('show')
   cy.get('[class="ExpandableSection__Wrapper-sc-wphg4w-2 hHpPBU"]>>[class="SidebarFieldWrapperstyles__FieldWrapper-sc-1p59g5d-1 iNlPyC"]> :nth-child(2)  >[class="ff_v882__ComponentState__wrapperEdit__Vyl ff__edit"]>:nth-child(2)').invoke('css', 'visibility','visible')
    //cy.get('[class="ExpandableSection__Wrapper-sc-wphg4w-2 hHpPBU"]>>[class="SidebarFieldWrapperstyles__FieldWrapper-sc-1p59g5d-1 iNlPyC"]> :nth-child(2)  >[class="ff_v882__ComponentState__wrapperEdit__Vyl ff__edit"]>:nth-child(2)').click({force: true})
  //person
